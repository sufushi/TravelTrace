...
public class MatrixUtils {
    ...
    //判断剪裁框是否在图片内
    public static boolean judgeIsImageContainsBorder(PuzzlePiece piece, float rotateDegrees) {
        sTempMatrix.reset();
    ...
    public static float[] calculateImageIndents(PuzzlePiece piece) {
    ...
    private static Matrix generateCenterCropMatrix(Area area, int width, int height,
        ...
        float offsetX = rectF.centerX() - width / 2.0f;
        float offsetY = rectF.centerY() - height / 2.0f;
