...
import static com.rdc.project.traveltrace.view.puzzle_view.util.SlantUtils.createLine;
import static com.rdc.project.traveltrace.view.puzzle_view.util.SlantUtils.cutArea;
import static com.rdc.project.traveltrace.view.puzzle_view.util.SlantUtils.cutAreaCross;
...
public abstract class SlantPuzzleLayout implements PuzzleLayout {
    ...
    @Override
    public void setOuterBounds(RectF baseRect) {
        reset();
