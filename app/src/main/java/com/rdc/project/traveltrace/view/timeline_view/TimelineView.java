package com.rdc.project.traveltrace.view.timeline_view;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, DensityUtil.dp2px(20, getContext()));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, DensityUtil.dp2px(2, getContext()));
        ...
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, DensityUtil.dp2px(8f, getContext()));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, DensityUtil.dp2px(4f, getContext()));
        typedArray.recycle();
