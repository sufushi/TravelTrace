...
import com.rdc.project.traveltrace.fragment.PersonMessageFragment;

public class PersonMessageActivity extends BaseBounceActivity {

    @Override
    protected String getToolBarTitle() {
        return getString(R.string.string_social_message);
    }
