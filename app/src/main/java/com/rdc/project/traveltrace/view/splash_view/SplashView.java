...
import com.rdc.project.traveltrace.utils.SvgPathParser;
...
public class SplashView extends View {
    ...
    private String mTitle = "Travel Trace";
    ...
    public SplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //init TowerPath
        String svg_path = context.getResources().getString(R.string.tower_svg_path);
        mTowerPath = new SvgPathParser().parsePath(svg_path);
