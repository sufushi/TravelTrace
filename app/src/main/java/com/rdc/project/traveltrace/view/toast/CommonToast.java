...
public class CommonToast {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, CommonToastUtils.getColor(context, R.color.normalColor),
                CommonToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, CommonToastUtils.getColor(context, R.color.normalColor),
                CommonToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CommonToastUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                CommonToastUtils.getColor(context, R.color.warningColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CommonToastUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                CommonToastUtils.getColor(context, R.color.warningColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CommonToastUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                CommonToastUtils.getColor(context, R.color.infoColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CommonToastUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                CommonToastUtils.getColor(context, R.color.infoColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CommonToastUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                CommonToastUtils.getColor(context, R.color.successColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CommonToastUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                CommonToastUtils.getColor(context, R.color.successColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CommonToastUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                CommonToastUtils.getColor(context, R.color.errorColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CommonToastUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                CommonToastUtils.getColor(context, R.color.errorColor), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, CommonToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), CommonToastUtils.getDrawable(context, iconRes),
                CommonToastUtils.getColor(context, tintColorRes), CommonToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, CommonToastUtils.getDrawable(context, iconRes),
                CommonToastUtils.getColor(context, tintColorRes), CommonToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, CommonToastUtils.getColor(context, tintColorRes),
                CommonToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, CommonToastUtils.getColor(context, tintColorRes),
                CommonToastUtils.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint)
            drawableFrame = CommonToastUtils.tint9PatchDrawableFrame(context, tintColor);
        else
            drawableFrame = CommonToastUtils.getDrawable(context, R.drawable.toast_frame);
        CommonToastUtils.setBackground(toastLayout, drawableFrame);

        if (withIcon) {
            if (icon == null)
                throw new IllegalArgumentException("Avoid passing 'icon' as null if 'withIcon' is set to true");
            CommonToastUtils.setBackground(toastIcon, tintIcon ? CommonToastUtils.tintIcon(icon, textColor) : icon);
        } else {
    ...
    public static class Config {
        private Typeface typeface = CommonToast.currentTypeface;
        private int textSize = CommonToast.textSize;

        private boolean tintIcon = CommonToast.tintIcon;
        ...
        public static void reset() {
            CommonToast.currentTypeface = LOADED_TOAST_TYPEFACE;
            CommonToast.textSize = 16;
            CommonToast.tintIcon = true;
            CommonToast.allowQueue = true;
        }
        ...
        public void apply() {
            CommonToast.currentTypeface = typeface;
            CommonToast.textSize = textSize;
            CommonToast.tintIcon = tintIcon;
            CommonToast.allowQueue = allowQueue;
        }
    }
